...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para el amor de mi vida:\n\nTe amo y amare para toda la vida aunque la distancia nos separe siempre te voy a encontrar.\n
...
Avy jorāelan mirre jēdari — te amo más de lo que las palabras alcanzan a decir.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Ares";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2026-08-15T00:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2027-08-15T00:00:00');
